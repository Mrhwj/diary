      ...
      <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
          <ul class="nav nav-sidebar">
            ...
            <li><a href="javascript:reflash('welcome.do')">收取</a></li>
          </ul>
          <ul class="nav nav-sidebar">
            <li><a href="javascript:reflash('inBoxList.do')">收件箱    <button id="enve" type="button" class="glyphicon glyphicon-envelope" data-container="body" data-toggle="popover" data-placement="right" data-content="今天下午2点会议室开会"></button></a></li>
          </ul>
          <ul class="nav nav-sidebar">
            <li><a>日常管理</a></li>
